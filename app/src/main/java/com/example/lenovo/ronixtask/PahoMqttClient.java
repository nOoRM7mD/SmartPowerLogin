...
public class PahoMqttClient {
    private MqttConnectOptions getMqttConnectionOption() {
        ...
        mqttConnectOptions.setWill("ronix/network", "I am going offline".getBytes(), 1, true);
        mqttConnectOptions.setUserName("qumrwmme");
        mqttConnectOptions.setPassword("oJHjXS7Xi0F9".toCharArray());
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    Log.d("SuccessMQTT", "Success" + getMqttConnectionOption().getWillMessage());
                }

                @Override
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    Log.d("FailureMQTT", "Failure " + exception.toString());
                }
            });
    ...
    public static void subscribe(@NonNull MqttAndroidClient client,
